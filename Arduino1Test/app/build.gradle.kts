...
android {
    namespace = "com.example.arduino1test"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.arduino1test"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("com.amplifyframework:aws-push-notifications-pinpoint:$amplify_version")
